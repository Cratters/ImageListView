...
public class MainActivity extends AppCompatActivity {
    ...
    String[] text2 = {"1hr ago","2hr ago","3hr ago","4hr ago","4hr ago"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SimpleAdapter adapter = new SimpleAdapter(this,list,R.layout.item_layout,new String[]{"imgResId","text1","text2"},new int[]{R.id.imageView,R.id.textView,R.id.textView2});
